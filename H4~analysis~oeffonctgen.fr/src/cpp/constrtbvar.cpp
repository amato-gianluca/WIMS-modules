...
##De Régine MANGEARD, Modifié par Cyrille Douriez (pas de borne infinie pour f(x), possible pour x)##
...
%% cas2=1 borne x +inf, =2 borne x -inf =3 ou4 bornée
...
\statement{<p>Dans le plan muni d'un repère orthogonal \((O,I,J)\),
on a tracé la courbe représentative d'une fonction \(f) définie sur l'intervalle \crog \vx1 ; \vx4 \crod .</p>
<div class="wimscenter">
 \draw{400,400}{\cadre}
</div>
<div class="wims_question">
Construire le tableau des variations de \(f) en draguant les éléments nécessaires
...
<div class="wims_instruction">En cas de mauvais positionnement déplacer la vignette : ? sur les éléments à modifier.</div>
}
...
\solution{
<p> Ci dessous : les points bleus sur la courbe sont les points où 
la courbe change de sens de variation, leurs coordonnées sont dans le tableau de variation.</p>
<div class="wimscenter">
 \draw{400,400}{
 \cadre
 \ptsol}
