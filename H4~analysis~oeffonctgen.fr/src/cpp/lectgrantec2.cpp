...
Votre réponse :
<ul><li>
antécédent(s) de \y0 : \embed{reply 1,3}
</li><li>
antécédent(s) de \y3 : \embed{reply 2,3}
</li></ul>
...
\answer{antécédent de y0}{\rep0}{type=\type1}
\answer{antécédent de y3}{\rep1}{type=\type2}
