...
%% 1: 1 antécédent 2: 3 antécédents
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Bugs dans la partie ci-dessous "k=4" : il faudrait modifier l'ensemble de définition de la fonction (qui n'est plus R)
Il faudrait aussi ajouter des ronds rouges aux extrémités de la courbe pour indiquer que ces points font bien partie de la courbe
(vérifier que c'est bien ce qui est sous-entendu par l'énoncé)
\if{\k=4}
{
