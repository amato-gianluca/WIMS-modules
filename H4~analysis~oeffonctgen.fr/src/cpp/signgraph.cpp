...
\real{S=\x1+\x2}
\real{P=\x1*\x2}
%%on fait en sorte que la courbe ne sorte pas de la fenêtre graphique :
...
\statement{Ci-dessous est tracée la courbe représentative d'une fonction f définie sur \(\mathbb{R}).
