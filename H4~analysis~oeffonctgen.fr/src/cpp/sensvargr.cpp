...
linewidth 2
  parallel -5,\ymin,-5,\ymax,1,0,12,blue
linewidth 2
vline 0,0,black
hline 0,0,black
...
on a tracé la courbe représentative d'une fonction \(f).<br />
Par lecture graphique déterminer le sens de variation de \(f)
