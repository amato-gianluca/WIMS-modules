...
\text{enonce=Associer à chaque expression algébrique l'ensemble de tous les réels x pour lesquels elle est définie.}
...
\answer{La réponse}{\data[;1];\data[;2]}{type=correspond}
