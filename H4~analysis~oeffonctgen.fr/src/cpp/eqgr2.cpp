...
\keywords{equations,roots,function,graphing}
...
%% fin image solution %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\text{enonce=Résoudre graphiquement l'équation : \(f(x) = \val)}
...
<br />L'ensemble des solution est : S= \embed{reply 1,3}</div>
\instruction
}
...
%%%%%%%% solution %%%%%%%%%%%%%%%%%
\solution{
\if{\goodrep[2]=}{La solution est \(\goodrep[1]).}{
\if{\goodrep[3]=}{Les solutions sont \(\goodrep[1]) et \(\goodrep[2])}{Les solutions sont \(\goodrep[1]), \(\goodrep[2]) et \(\goodrep[3]).}}
