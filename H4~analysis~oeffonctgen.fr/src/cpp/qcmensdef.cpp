...
: choix d'un type c'est-à-dire d'une ligne de la matrice data
...
\statement{Choisir l'ensemble de définition de la fonction \(f\) de la variable réelle
\(x\) définie par \(f(x) = \data[\q;1]\).
<div>
...
\answer{La réponse}{\q;\data[;2]}{type=radio}{option=shuffle}
