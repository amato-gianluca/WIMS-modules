...
\statement{
<p>
      Une fonction \(f) est donnée par son tableau de valeurs:
</p>
...
Votre réponse :
<ul><li>
antécédent(s) de \q1 : \embed{reply 1,8}
</li><li>
antécédent(s) de \q2 : \embed{reply 2,8}
</li><li>
antécédent(s) de \q3 : \embed{reply 3,8}
</li><li>
antécédent(s) de \q4 : \embed{reply 4,8}
</li></ul>
...
\answer{antécédent(s) de \q1}{\rep1}{type=\type1}
\answer{antécédent(s) de \q2}{\rep2}{type=\type2}
\answer{antécédent(s) de \q3}{\rep3}{type=\type3}
\answer{antécédent(s) de \q4}{\rep4}{type=\type4}
