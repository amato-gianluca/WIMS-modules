...
<p style = "background-color: #FFCC66"> Méthode pour calculer la dérivée de la fonction définie 
...
<p> En utilisant cette formule, <label for="reply4">on obtient la dérivée de f  :</label></p>
