...
<p>
<label for="reply1">L'équation réduite de la tangente à la courbe \(C) au point d'abscisse \(\x0) est :</label><br /> y =  \embed{reply1}. </p>
<b>(L'écrire sous la forme y = ax+b)</b>}
...
La tangente passe par le point de coordonnées (\x0 ; <i>f</i> (\x0)) et a comme coefficient directeur <i>f</i> '(\x0)</b><p>
