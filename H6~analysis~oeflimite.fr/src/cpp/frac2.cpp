...
<tr><td> Au numérateur</td><td>\embed{reply4,120x30}</td></tr>
<tr><td> Au dénominateur</td><td>\embed{reply5,120x30}</td></tr>
</table>
}
{
...
\answer{numérateur}{\nc;\termes}{type=clickfill}
\answer{dénominateur}{\dc;\termes}{type=clickfill}
