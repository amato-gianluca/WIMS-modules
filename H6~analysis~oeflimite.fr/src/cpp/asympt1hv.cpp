...
\if{\step = 1}{
<br/>Peut-on en déduire que la courbe \(C) admet une droite asymptote ?\embed{reply1}}
\if{\step = 2}{<br/>On peut en déduire que la courbe \(C) admet une droite asymptote d'équation : \embed{reply2}
}
}
